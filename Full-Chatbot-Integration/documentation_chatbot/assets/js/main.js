(function ($) {
  ...
  scrollProgress();
    ...
    $('.tools-item.mode').on("click", function () {
        ...
        if (modes == "light") {
            $("body").attr("data-bs-theme", "light");
			// Force remove dark mode and set light mode with delay to ensure proper application
			$('.sidebar, .main-content, .wrapper, body, html').removeClass('dark-mode').removeAttr('data-mode');
			setTimeout(function() {
				$('.sidebar, .main-content, .wrapper, body, html').attr('data-mode', 'light');
			}, 10);
            $("#dark").remove();
            var headerModes = $(".tools-item.header").attr("data-header-mode");
            if (headerModes == "light") {
            ...
            $("body").attr("data-bs-theme", "dark");
			// Force remove light mode and set dark mode with delay to ensure proper application
			$('.sidebar, .main-content, .wrapper, body, html').removeClass('light-mode').removeAttr('data-mode');
			setTimeout(function() {
				$('.sidebar, .main-content, .wrapper, body, html').attr('data-mode', 'dark');
			}, 10);
            $("#mainCss").after($link);
            var headerModes = $(".tools-item.header").attr("data-header-mode");
            if (headerModes == "light") {
