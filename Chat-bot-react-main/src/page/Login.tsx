      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold" style={{ color: "#652d90" }}>
            {isFirstLogin ? "Set New Password" : "Admin Login"}
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
          ...
          >
            {!isFirstLogin ? (
              ...
              <>
                <Alert
                  message="First Login Setup"
                  description={`Welcome! Please set a new password for ${firstLoginData?.email}`}
                  type="info"
                  icon={<MdLockReset />}
                  className="mb-6"
                />
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500">
            Secure login for authorized agents only
          </p>
        </div>
      </div>
    </div>
