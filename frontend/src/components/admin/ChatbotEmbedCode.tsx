...
const ChatbotEmbedCode: React.FC<ChatbotEmbedCodeProps> = ({
  ...
  const generateEmbedCode = () => {
    const staticBaseUrl = import.meta.env.VITE_STATIC_BASE_URL || "https://bot.spell.com.np/static";
    return `<script src="${staticBaseUrl}/chatbot.js" data-company="${companyId}"></script>`;
  };
